...
Contributions should keep Hypershell Reach generic, bounded and easy to operate.
...
Bug reports should include the smallest reproducible behavior, expected result, observed result and relevant Hypershell Reach version or commit without including secrets or private deployment data.
