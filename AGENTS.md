...
This repository contains the generic Hypershell Reach product. Keep private deployment configuration, credentials, private host details and deployment-specific policy outside this repository.

## Repository rules

1. Prefer the smallest maintainable design that preserves typed configuration and explicit extension points.
2. Reuse an existing MCP capability, Hypershell Reach tool or narrow extension point before adding reusable machinery.
